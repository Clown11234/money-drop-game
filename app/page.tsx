...
export default function MoneyDropFinal() {
  ...
  const audioFiles = {
    ...
    heartbeat:
      "https://actions.google.com/sounds/v1/human_voices/heartbeat.ogg",
        ...
        >
          ...
          <div className="space-y-6 mb-8">
            <div className="relative">
              <label className="block text-left text-sm font-semibold text-slate-400 mb-2 ml-1">
                PLAYER 1
              </label>
              <input
          ...
          <p className="text-xs text-slate-500 mt-6">
            Enter both player names to continue
          </p>
        </motion.div>
      </div>
    );
  ...
  if (gameState === "INTRO")
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-black via-blue-950/30 to-black relative overflow-hidden">
        ...
        >
          <div className="mb-8">
            <p className="text-blue-400 font-bold tracking-widest text-sm uppercase mb-4">
              Level {level}
            </p>
            <motion.h1
  ...
  if (gameState === "CATEGORY_SELECT")
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-slate-950 via-purple-950/10 to-slate-950 text-white p-4 relative overflow-hidden">
        ...
        >
          <p className="text-blue-400 font-bold tracking-[0.3em] text-sm mb-2 uppercase">
          ...
          <p className="text-slate-400 mt-2">
            Level {level} • ${totalMoney.toLocaleString()}
          </p>
        </motion.div>
  ...
  return (
    <motion.main
      ...
      className={`h-screen flex flex-col bg-gradient-to-b ${
        ...
        <div className="relative">
          <div className="text-center">
            ...
            <motion.div
              ...
              transition={
                timeLeft <= 10 ? { repeat: Infinity, duration: 0.5 } : {}
              }
              className="relative"
            >
              ...
              {/* Progress ring */}
              <svg
                className="absolute -inset-2 w-20 h-20 -z-10"
                viewBox="0 0 100 100"
              >
                <circle
                  cx="50"
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute inset-x-0 bottom-32 top-0 flex flex-wrap-reverse justify-center content-start gap-1 p-3 overflow-hidden z-10 pointer-events-none">
                    <AnimatePresence>
                      {[...Array(Math.floor(currentBet / BET_STEP))].map(
                        (_, i) => (
                          <motion.div
                            key={i}
                            initial={{
          ...
          {gameState === "PLAYING" && (
            ...
            >
              <p className="text-sm text-slate-500 font-medium">
                Distribute your ${totalMoney.toLocaleString()} across the
                options. Click +500K to add bets.
              </p>
            </motion.div>
          )}
        </div>
